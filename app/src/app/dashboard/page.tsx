    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] text-white">
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          <div className="mt-12 p-6 bg-[#111] rounded-xl border border-[#2A2A2A] text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/login" className="px-6 py-2 border border-[#2A2A2A] text-[#ccc] rounded-sm hover:border-[#B8956A] hover:text-[#B8956A] transition-colors font-bold tracking-wider">
                ENTRAR
              </Link>
              <Link href="/register" className="px-6 py-2 bg-[#B8956A] text-[#0A0A0A] font-bold tracking-wider rounded-sm hover:bg-[#9A7A50] transition-colors">
                CRIAR CONTA
              </Link>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 pb-24">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="p-4 bg-[#111] border border-[#2A2A2A] rounded-lg text-center">
            <BookOpen className="w-5 h-5 text-[#B8956A] mx-auto mb-2" />
          ...
          <div className="p-4 bg-[#111] border border-[#B8956A]/30 rounded-lg text-center">
            <Target className="w-5 h-5 text-[#B8956A] mx-auto mb-2" />
          ...
          <div className="p-4 bg-[#111] border border-[#2A2A2A] rounded-lg text-center">
            <Dumbbell className="w-5 h-5 text-[#B8956A] mx-auto mb-2" />
        ...
        <div className="mb-12 p-6 bg-[#111] rounded-xl border border-[#2A2A2A]">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold tracking-wider">SUA JORNADA</h2>
            <span className="text-[#B8956A] font-bold tracking-wider">{progressPercent}%</span>
          </div>
