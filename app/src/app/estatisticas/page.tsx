  ...
  <div className="min-h-screen bg-background text-white pb-24">
   <header className="border-b border-border sticky top-0 bg-background/95 backdrop-blur-sm z-50">
    <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
     ...
     <Link href="/planilha" className="text-sm text-muted-foreground hover:text-white">
      Planilha
     </Link>
    </div>
   </header>
   ...
   <main className="max-w-6xl mx-auto px-4 py-6">
    {!user ? (
     <div className="mb-6 p-5 rounded border border-secondary bg-surface text-center">
      <p className="mb-3 text-muted-foreground">Faça login para ver suas estatísticas.</p>
     ...
     <>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-8">
       <div className="p-4 bg-card border border-border rounded-lg">
        ...
        <div className="text-sm text-muted-foreground tracking-wider">PRs</div>
       </div>
       <div className="p-4 bg-card border border-border rounded-lg">
        <Activity className="w-6 h-6 text-primary mb-2" />
        <div className="text-2xl font-bold">{formatVolume(stats.totalVolume)}</div>
        <div className="text-sm text-muted-foreground tracking-wider">Volume Total</div>
       </div>
       <div className="p-4 bg-card border border-border rounded-lg">
        <BarChart2 className="w-6 h-6 text-primary mb-2" />
        <div className="text-2xl font-bold">{stats.exercises.length}</div>
        <div className="text-sm text-muted-foreground tracking-wider">Exercícios</div>
       </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-4">
       ...
       <span className="text-xs text-muted-foreground">Ordenado por PR</span>
      </div>
