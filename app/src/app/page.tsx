      ...
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded bg-primary/20 text-primary text-sm font-bold tracking-wider mb-8">
       ...
       DISCIPLINA NÃO É MOTIVAÇÃO. É MÉTODO.
        ...
        <p className="text-sm sm:text-base text-muted-foreground mb-6 max-w-xl mx-auto font-light leading-relaxed normal-case">
         6 semanas de treino de costas estruturado por João Monteiro — Campeão Brasileiro de Fisiculturismo, profissional de Educação Física e Nutrição.
        </p>
        ...
        <div className="inline-flex items-center gap-3 px-4 py-2 bg-surface border border-border rounded-full mb-10">
         ...
         <span className="text-[10px] sm:text-xs font-bold tracking-wider text-muted-foreground">11 CAPÍTULOS · TEXTO DIRETO · LEITURA RÁPIDA</span>
        </div>
