...
import { LayoutDashboard, BookOpen, Dumbbell, Users, Settings, FileText } from 'lucide-react'
...
export function AdminSidebar({ profile }: { profile: AdminProfile }) {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-56 bg-[oklch(15%.01_270)] border-r border-[oklch(25%.01_270)] flex flex-col z-50">
